...
typedef NS_ENUM(NSUInteger, JDDOFCacheElementStatus) {
    JDDOFCacheElementStatus_localAvailable = 1,//本地版本正常可用
    JDDOFCacheElementStatus_dowloading = 2, //正在下载中
};
...
@property (nonatomic, copy) NSString *version;//发布版本，网路版本非本地文件版本
...
@property (nonatomic, copy) NSString *versionWithFile;//真实的文件版本
